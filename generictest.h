...
#ifndef HPCSWTEST_GENERICTEST_H_
#define HPCSWTEST_GENERICTEST_H_
/* Header guard to prevent multiple declaration*/
...
class GenericTest: public AppTest {
  ...
  public:
    GenericTest(const jobscript::JOBSCRIPT &, const std::string &);
    GenericTest(const jobscript::JOBSCRIPT &);
    virtual ~GenericTest(void) {};
